...
function Section1() {
  ...
  return (
    <section className="py-20 md:pt-[150px] md:pb-[130px] relative z-[0] hero-after bg-hero-image">
      <div id="sec1" className="container mx-auto flex flex-wrap lg:flex-nowrap h-full justify-center items-center">
        ...
        /> */}
        <div className="w-full  flex flex-col justify-center items-center z-[1] max-w-[740px] text-white text-center lg:text-left  mt-20">
          <h1
          ...
          <p className={`text-[18px] mt-4  transition-all duration-1000  ${
            pIntersecting
              ? "translate-y-0 opacity-100"
              : "translate-y-32 opacity-0"
          }`}>
          ...
          <div className={`hidden md:flex mt-8 text-black gap-4 transition-all duration-[1500ms]  ${
            pIntersecting
              ? "translate-y-0 opacity-100"
              : "translate-y-32 opacity-0"
          }`}>
            <Link
              ...
              className="px-5 py-2 font-semibold text-[18px] bg-[#B2DDFF] rounded-[10px]"
            >
              Roof Replacement
            </Link>
            <Link
              href={"/services/roof-repair"}
              className="px-5 py-2 font-semibold text-[18px] bg-[#C7D7FE] rounded-[10px]"
            >
              Roof Repair
            </Link>
            <Link
              href={"/services"}
              className="px-5 py-2 font-semibold text-[18px] bg-[#D5D9EB] rounded-[10px]"
            >
              Learn More
            </Link>
          </div>
          <div className={`hidden md:flex flex-col justify-center items-center mt-8 gap-3 transition-all duration-[1500ms] ${
            pIntersecting
              ? "translate-y-0 opacity-100"
              : "translate-y-32 opacity-0"
          }`}>
            ...
            <p className="text-[18px] font-normal">
              Rating, Trusted by many home owners
            </p>
            <div className={`hidden md:flex mt-8 text-black gap-4 transition-all duration-[1500ms]  ${
            pIntersecting
              ? "translate-y-0 opacity-100"
